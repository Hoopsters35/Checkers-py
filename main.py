...
while board.hasmove(t1):
    ...
    isCaptureMove = board.possiblemoves(currentUserMove.group(1))[currentUserMove.group(2)]
    ...
    while isCaptureMove == True:
        ...
        anothercap = False
        possibleFollowupMoves = board.possiblemoves(currentUserMove.group(2))
        ...
        if not anothercap: break
            ...
            if askForMulticapture.lower() == 'y':
                ...
                while not (nextUserMove.group(1) == currentUserMove.group(2) and board.possiblemoves(nextUserMove.group(1))[nextUserMove.group(2)] == True):
